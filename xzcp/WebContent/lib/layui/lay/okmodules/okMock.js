				...
				function(exprots) {
					let okMock = {
						api : {
							...
							listCommitteeRecord : "http://localhost:7050/xzcp/record/getAllCommitteeRecord",
							listSeachRecordIT : "http://localhost:7050/xzcp/record/seachRecordIT",
							listStudentScore : "http://localhost:7050/xzcp/score/getScoreS",
							listSeachStudentScore : "http://localhost:7050/xzcp/score/seachScoreS",
							listStudentTermscore : "http://localhost:7050/xzcp/termscore/getTermscoreS",
							listStudentRecord : "http://localhost:7050/xzcp/record/getRecordS",
							listSeachStudentRecord : "http://localhost:7050/xzcp/record/seachRecordS",
							listInstructorRecord : "http://localhost:7050/xzcp/record/getRecordI",
							listSeachInstructorRecord : "http://localhost:7050/xzcp/record/seachRecordI",
							listInstructorScore : "http://localhost:7050/xzcp/score/getScoreI",
							listSeachInstructorScore : "http://localhost:7050/xzcp/score/seachScoreI",
							listInstructorTermscore : "http://localhost:7050/xzcp/termscore/getTermscoreI",
							listSeachInstructorTermscore : "http://localhost:7050/xzcp/termscore/seachTermscoreI",
							listTeacherRecord : "http://localhost:7050/xzcp/record/getRecordT",
							listSeachTeacherRecord : "http://localhost:7050/xzcp/record/seachRecordT",
							listTeacherScore : "http://localhost:7050/xzcp/score/getScoreT",
							listSeachTeacherScore : "http://localhost:7050/xzcp/score/seachScoreT",
							listTeacherTermscore : "http://localhost:7050/xzcp/termscore/getTermscoreT",
							listSeachTeacherTermscore : "http://localhost:7050/xzcp/termscore/seachTermscoreT",
